...
/**
 * Title: Archive
 * Slug: hairsaloon/archive
 * Categories: hairsaloon, archive
 */
?>
...
<h3 class="wp-block-heading footer-widget-title has-medium-font-size"><?php esc_html_e('Popular Posts','hairsaloon'); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"10px","right":"10px","bottom":"10px","left":"10px"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px"><!-- wp:heading {"level":3,"className":"footer-widget-title","fontSize":"medium"} -->
<h3 class="wp-block-heading footer-widget-title has-medium-font-size"><?php esc_html_e('Archives','hairsaloon'); ?></h3>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"10px","right":"10px","bottom":"10px","left":"10px"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px"><!-- wp:heading {"level":3,"className":"footer-widget-title","fontSize":"medium"} -->
<h3 class="wp-block-heading footer-widget-title has-medium-font-size"><?php esc_html_e('Tags','hairsaloon'); ?></h3>
<!-- /wp:heading -->
